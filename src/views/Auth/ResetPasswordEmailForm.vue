  ...
  methods: {
    ...
    async submitForm() {
      ...
      try {
        ...
        localStorage.setItem("Aqar_admin_dashboard_verification_code", res.data.data.code);
        localStorage.setItem("Aqar_admin_dashboard_forget_pass_token", res.data.data.access_token);
