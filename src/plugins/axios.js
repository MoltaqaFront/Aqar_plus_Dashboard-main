...
// Global headers
axios.defaults.baseURL = "https://aqar-plus.com/dashboard-api/v1/";
...
axios.interceptors.request.use(
  ...
  function (error) {
    ...
    if (error.response.status === 401) {
      localStorage.removeItem("Aqar_admin_dashboard_user_id");
      localStorage.removeItem("Aqar_admin_dashboard_user_token");
      localStorage.removeItem("Aqar_admin_dashboard_userName");
      router.replace("/");
    }
